...
import com.example.majid_fit5.al_rajhitakaful_TEST.data.models.user.User;
...
public class CurrentUserResponse implements Parcelable
{
    ...
    public final static Creator<CurrentUserResponse> CREATOR = new Creator<CurrentUserResponse>() {
